...
from aws_exe_sys.common import dynamodb, s3 as s3_ops
from aws_exe_sys.common.statuses import RUNNING, TERMINAL_STATUSES, SUCCEEDED, FAILED, TIMED_OUT
...
def read_state(
    ...
    for order in orders:
        ...
        # New result found — update state. ``result`` is a ResultV1
        # dataclass instance now, so access fields as attributes;
        # ``from_dict`` already enforced presence of status/log.
